...
def Low_Illumination_Degrading(img, safe_invert=False):    # ZY: 论文3.3.2
    ...
    # print(rgb2cam)
    img3 = apply_ccm(img2, rgb2cam)    # ZY: 论文公式(9)
    ...
    img9 =apply_ccm(img8, cam2rgb)    # ZY: 论文公式(8)
    # gamma correction
